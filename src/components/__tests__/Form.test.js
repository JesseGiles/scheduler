...
describe("Form", () => {
  ...
  it("renders with intitial student name", () => {
    const { getByTestId } = render(
      <Form interviewers={interviewers} student="Lydia Miller-Jones" />
    );
    expect(getByTestId("student-name-input")).toHaveValue("Lydia Miller-Jones");
  });
  // In the example above, we have shown two ways to access the student name input element. We can use getByPlaceholderText("Enter Student Name") or getByTestId("student-name-input") to find the same element in the DOM.
